...
class Violation extends AbstractAPI
{
     ...
     *                       'X-EBAY-C-MARKETPLACE-ID'	string	This header is required and is used to specify
     *                       the eBay marketplace identifier. Supported values for this header can be found
     *                       in the MarketplaceIdEnum type definition. Note that Version 1.4.0 of the
